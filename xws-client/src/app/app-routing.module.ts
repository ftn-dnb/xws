...
import { HOME_PATH, LOGIN_PATH, REGISTRATION_PATH, VERIFY_ACCOUNT_PATH, MY_PUBLICATIONS_PATH, PUBLICATION_PATH, BUSINESS_PROCESSES } from './config/router-paths';
...
const routes: Routes = [
  ...
  { path: BUSINESS_PROCESSES, component: BusinessProcessComponent },
];

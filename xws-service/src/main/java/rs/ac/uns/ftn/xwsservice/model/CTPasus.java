...
public class CTPasus {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "Tekst", namespace = "http://www.ftn.uns.ac.rs/xws/tim5", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Slika", namespace = "http://www.ftn.uns.ac.rs/xws/tim5", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Lista", namespace = "http://www.ftn.uns.ac.rs/xws/tim5", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Tabela", namespace = "http://www.ftn.uns.ac.rs/xws/tim5", type = JAXBElement.class, required = false)
    })
    @XmlMixed
    ...
    public static class Lista {
         ...
         * 
         */
        public List<String> getStavka() {
            if (stavka == null) {
                stavka = new ArrayList<String>();
            }
            return this.stavka;
        }

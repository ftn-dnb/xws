...
import { API_BUSINESS_PROCESSES, API_SHOW_MY_REVIEW_REQUESTS, API_ACCEPT_REVIEW_REQUEST, API_DECLINE_REVIEW_REQUEST, API_ACCEPT_PUBLICATION, API_DECLINE_PUBLICATION, API_RECOMMEND_REVIEWERS, API_ADD_REVIEWERS, API_ADD_REVIEW, API_GET_REVIEW_PROCESS_ID, API_CHANGE_PHASE, API_GET_PROCESS_BY_PUB_ID } from './../config/api-paths';
...
export class BusinessProcessService {
  ...
  getProcessByPublicationId(publicationId: string): Observable<any> {
    return this.http.get(API_GET_PROCESS_BY_PUB_ID + publicationId);
  }
}

...
public class CTPasus {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "Tabela", namespace = "naucni_rad", type = JAXBElement.class),
        @XmlElementRef(name = "Lista", namespace = "naucni_rad", type = JAXBElement.class),
        @XmlElementRef(name = "Slika", namespace = "naucni_rad", type = JAXBElement.class),
        @XmlElementRef(name = "Tekst", namespace = "naucni_rad", type = JAXBElement.class)
    })
    @XmlMixed
